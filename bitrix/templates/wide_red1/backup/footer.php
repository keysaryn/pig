				...
				<div id="sidebar">
					...
					<div id="tags-stub-id">
						...
						<div class="sidebar-box new-comments">
							...
							<div class="sidebar-box-content">
						<?$APPLICATION->IncludeComponent("bitrix:blog.new_comments", "personal", array(
						"SEO_USER" => "N",
							"COMMENT_COUNT" => "4",
							"MESSAGE_LENGTH" => "80",
							"DATE_TIME_FORMAT" => GetMessage("DATE_FORMAT"),
...
<!-- TODO: Разобраться как работает setAdditionCss -->
<?// $APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/blog.css");?>z